<script>
    ...
    export default {
        props: ["physician","sameSpeciality","differentSpeciality","memberId","adminRemark","memberRemark"],
        data(){
            ...
            return {
                form: {
                    ...
                    flag1: (this.memberRemark ? (this.memberRemark.flag1 == 1 ? 1 : 0) : ''),
                    flag2: (this.memberRemark ? (this.memberRemark.flag2 == 1 ? 1 : 0) : ''),
                    flag3: (this.memberRemark ? (this.memberRemark.flag3 == 1 ? 1 : 0) : ''),
                    flag4: (this.memberRemark ? (this.memberRemark.flag4 == 1 ? 1 : 0) : ''),
                    flag5: (this.memberRemark ? (this.memberRemark.flag5 == 1 ? 1 : 0) : ''),
                    flag6: (this.memberRemark ? (this.memberRemark.flag6 == 1 ? 1 : 0) : ''),
                    description1: (this.memberRemark ? (this.memberRemark.description1 || "") : ''),
                    description2: (this.memberRemark ? (this.memberRemark.description2 || "") : ''),
                    description3: (this.memberRemark ? (this.memberRemark.description3 || "") : ''),
                    description4: (this.memberRemark ? (this.memberRemark.description4 || "") : ''),
        ...
        methods: {
            onSubmit: function(){
                ...
                try{
                    ...
                    axios.post($vm.route('remarks.save'),$vm.form).then(({data}) => {
...
<template>
    <FrontendLayout>
        ...
        <div class="flex flex-col py-8 bg-gray">
            <div class="max-w-[1440px] px-4 w-full mx-auto flex flex-col items-center gap-y-3 mb-8" v-if="adminRemark">
                <div class="w-full flex gap-5">
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        ...
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag1" value="1" class="w-5 h-5" :checked="adminRemark.flag1 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag1" value="0" class="w-5 h-5" :checked="adminRemark.flag1 == '0'" disabled/> No</label>
                        </div>
                    </div>
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        <label class="flex-1 text-md text-lightBlack font-medium">BOARD CERTIFICATION</label>
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag2" value="1" class="w-5 h-5" :checked="adminRemark.flag2 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag2" value="0" class="w-5 h-5" :checked="adminRemark.flag2 == '0'" disabled/> No</label>
                        </div>
                    </div>
                </div>
                <div class="w-full flex gap-5">
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        ...
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag3" value="1" class="w-5 h-5" :checked="adminRemark.flag3 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag3" value="0" class="w-5 h-5" :checked="adminRemark.flag3 == '0'" disabled/> No</label>
                        </div>
                    </div>
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        <label class="flex-1 text-md text-lightBlack font-medium">PRACTICE IN O.C. FOR LAST 5 YEARS?</label>
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag4" value="1" class="w-5 h-5" :checked="adminRemark.flag4 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag4" value="0" class="w-5 h-5" :checked="adminRemark.flag4 == '0'" disabled/> No</label>
                        </div>
                    </div>
                </div>
                <div class="w-full flex gap-5">
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        ...
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag5" value="1" class="w-5 h-5" :checked="adminRemark.flag5 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag5" value="0" class="w-5 h-5" :checked="adminRemark.flag5 == '0'" disabled/> No</label>
                        </div>
                    </div>
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        <label class="flex-1 text-md text-lightBlack font-medium">PEER EVAL #1 SAME SPECIALTY (MEETS CRITERIA?)</label>
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag6" value="1" class="w-5 h-5" :checked="adminRemark.flag6 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag6" value="0" class="w-5 h-5" :checked="adminRemark.flag6 == '0'" disabled/> No</label>
                        </div>
                    </div>
                </div>
                <div class="w-full flex gap-5">
                    <div class="flex flex-1 w-full items-start gap-8 mt-4">
                        ...
                        <div class="flex items-center gap-5 w-40 shrink-0">
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag7" value="1" class="w-5 h-5" :checked="adminRemark.flag7 == '1'" disabled/> Yes</label>
                            <label class="text-md flex items-center gap-2"><input type="radio" name="flag7" value="0" class="w-5 h-5" :checked="adminRemark.flag7 == '0'" disabled/> No</label>
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-center bg-darkBlue text-white text-xl font-semibold px-5 py-3">Please Enter Your Remarks Below:</div>
        <div class="flex flex-col py-8 bg-gray">
            <form class="max-w-[1440px] px-4 w-full mx-auto flex flex-col items-center gap-y-3 mb-8" @submit.prevent="onSubmit">
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS CRITERION 1</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag1" value="1" class="w-5 h-5" v-model="form.flag1"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag1" value="0" class="w-5 h-5" v-model="form.flag1"/> No</label>
                    </div>
                    <input class="flex-1 text-base" placeholder="Comment" v-model="form.description1"/>
                </div>
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS CRITERION 2</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag2" value="1" class="w-5 h-5" v-model="form.flag2"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag2" value="0" class="w-5 h-5" v-model="form.flag2"/> No</label>
                    </div>
                    <input class="flex-1 text-base" placeholder="Comment" v-model="form.description2"/>
                </div>
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS CRITERION 3</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag3" value="1" class="w-5 h-5" v-model="form.flag3"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag3" value="0" class="w-5 h-5" v-model="form.flag3"/> No</label>
                    </div>
                    <input class="flex-1 text-base" placeholder="Comment" v-model="form.description3"/>
                </div>
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS CRITERION 4</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag4" value="1" class="w-5 h-5" v-model="form.flag4"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag4" value="0" class="w-5 h-5" v-model="form.flag4"/> No</label>
                    </div>
                    <input class="flex-1 text-base" placeholder="Comment" v-model="form.description4"/>
                </div>
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS 2 OF FIRST 3 CRITERIA: (criteria 1-3 only)</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag5" value="1" class="w-5 h-5" v-model="form.flag5"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag5" value="0" class="w-5 h-5" v-model="form.flag5"/> No</label>
                    </div>
                    <input class="flex-1 text-base" placeholder="Comment" v-model="form.description5"/>
                </div>
                <div class="flex flex-1 w-full items-start gap-8 mt-4">
                    <label class="w-96 text-md text-lightBlack font-medium">MEETS 2 OF 4 CRITERIA: (including #4)</label>
                    <div class="flex items-center gap-5 w-40 shrink-0">
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag6" value="1" class="w-5 h-5" v-model="form.flag6"/> Yes</label>
                        <label class="text-md flex items-center gap-2"><input type="radio" name="flag6" value="0" class="w-5 h-5" v-model="form.flag6"/> No</label>
                    </div>
