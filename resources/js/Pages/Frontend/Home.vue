    ...
    export default {
        ...
        methods: {
            ...
            handleAutoSave: function(){
                try{
                    axios.post(this.route('save-physician'),this.form).then(({data}) => {
    ...
    <FrontendLayout>
        ...
        <form @submit.prevent="handleAutoSave">
            ...
            <div class="flex gap-8 py-10 mt-4 justify-center">
                <button class="rounded-lg bg-blue text-white px-8 py-2 text-md uppercase font-medium">Save</button>
